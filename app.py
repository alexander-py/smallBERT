...
def answer_prediction(question, answer_text):
    ...
    start_scores, end_scores = model(torch.tensor([token_indices]), \
...
def index():
    ...
    if request.method == 'POST':
      ...
      bertParagraph = form['paragraph']
      question = form['question']

      result.append(form['question'])
      result.append(answer_prediction(question, bertParagraph))
